...
Note: The original file provided by The TensorFlow Authors was modified to fit our own tflite model.
==============================================================================*/
...
const int32_t kInferencesPerCycle = 20;
...
float loop(float pressure) {
  ...
  float x = pressure;
  //float x = 27000 + inference_count*5000;
